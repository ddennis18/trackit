export default function SideBar () {
  return (
    <div className='fixed w-[150px] bg-white h-screen space-y-4 border-gray-500 border-r-1 pt-4'>
      ...
      <nav className='grid grid-cols-1 gap-4'>
        ...
        <button className='border-b-1 border-gray-500 pl-2 font-semibold text-left'>Logout</button>
      </nav>
    </div>
  )
}
